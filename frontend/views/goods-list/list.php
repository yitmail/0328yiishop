			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?=Yii::getAlias('@web')?>/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="http://www.yiishop.com/goods-intro/goods?id=<?=$list->id?>">
                                    <?php
                                    if(substr($list->logo,0,7)=='http://'){

                                        echo  "<img src='$list->logo' alt='' />";
                                    }else{
                                        echo  "<img src='http://admin.yiishop.com$list->logo' alt='' />";
                                    }
                                    ?>
                                </a></dt>
							<dd><a href=""><?=$list->name?></a></dd>
