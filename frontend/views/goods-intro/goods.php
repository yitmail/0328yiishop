			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						...
						<a href="http://admin.yiishop.com<?=$photos[0]->path?>" class="jqzoom" rel="gal1">
                            <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.yiishop.com<?=$photos[0]->path?>" alt="" style="height: 350px;width: 350px;" />
                            <!-- 第一幅图片的中图 -->
						</a>

					</div>
	
					<!--使用说明：此处的预览图效果有三种类型的图片，大图，中图，和小图，取得图片之后，分配到模板的时候，把第一幅图片分配到 上面的midpic 中，
					其中大图分配到 a 标签的href属性，中图分配到 img 的src上。 下面的smallpic 则表示小图区域，格式固定，
					在 a 标签的 rel属性中，分别指定了中图（smallimage）和大图（largeimage），img标签则显示小图，按此格式循环生成即可，
					但在第一个li上，要加上cur类，同时在第一个li 的a标签中，添加类 zoomThumbActive  -->
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									...
									smallimage: 'http://admin.yiishop.com<?=$photo->path?>',
									largeimage: 'http://admin.yiishop.com<?=$photo->path?>'}">
                                     <img src="http://admin.yiishop.com<?=$photo->path?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><strong><?=date('Y-m-d H:i:s',$goods->create_time)?></strong> </li>
